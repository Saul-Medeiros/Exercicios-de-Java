...
public class TelaTriangulo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Captura de Tela (42).png"))); // NOI18N
        ...
        lblStatus.setFont(new java.awt.Font("Comic Sans MS", 1, 24)); // NOI18N
        lblStatus.setForeground(new java.awt.Color(51, 51, 255));
        lblStatus.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lblStatus.setText("Forma ou não?");

        lblTipo.setFont(new java.awt.Font("Comic Sans MS", 1, 24)); // NOI18N
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        ...
        int b = sliB.getValue();
        int c = sliC.getValue();
        if (a<b+c && b<a+c && c<a+b){//um dos lados tem que ser menor que a soma dos outros 2 para formar um triângulo
            lblStatus.setText("Formam um triângulo");
            if (a==b && b==c) {//todos os lados iguais
                lblTipo.setText("Equilátero");
            } else if (a!=b && b!=c && a!=c) {//todos os lados diferentes
                lblTipo.setText("Escaleno");
            } else {
                lblTipo.setText("Isósceles");//dois lados iguais e um diferente
            }
        } else {
