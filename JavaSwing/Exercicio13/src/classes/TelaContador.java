...
public class TelaContador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        sliInicio.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        ...
        sliFim.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        ...
        sliPasso.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        ...
        lblInicio.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        lblInicio.setText("0");

        lblFim.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        lblFim.setText("6");

        lblPasso.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        lblPasso.setText("1");

        btnCont.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
        ...
        lstCont.setFont(new java.awt.Font("Comic Sans MS", 1, 18)); // NOI18N
    ...
    private void btnContActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContActionPerformed
        ...
        DefaultListModel lista = new DefaultListModel();//instância da classe DefaultListModel
        
        for (int c=i; c<=f; c+=p) {
           lista.addElement(c);//adiciona o valor de c a lista quantas vezes o loop rodar
        }
        
        lstCont.setModel(lista);//adiciona o objeto lista a lista do projeto
